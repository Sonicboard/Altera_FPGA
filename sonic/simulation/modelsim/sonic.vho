...
-- clk_origin	=>  Location: PIN_28,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- data_outpin	=>  Location: PIN_33,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data_outpin_2	=>  Location: PIN_86,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- pragma translate_on
PORT MAP (
	datab => \inst2|clk_out_internal~q\,
	datac => \inst2|counter\(0),
	datad => \inst2|counter\(1),
...
-- Equation(s):
-- \inst|Equal2~1_combout\ = (!\inst|j\(0) & (\inst|j\(1) & (!\inst|j\(2) & \inst|Equal2~0_combout\)))
...
-- Equation(s):
-- \inst1|j[6]~8_combout\ = (\inst1|Add1~12_combout\ & (((\inst1|j[7]~0_combout\ & \inst1|j\(6))) # (!\inst1|j[7]~1_combout\))) # (!\inst1|Add1~12_combout\ & (\inst1|j[7]~0_combout\ & (\inst1|j\(6))))
...
-- Equation(s):
-- \inst1|j[7]~9_combout\ = (\inst1|Add1~14_combout\ & (((\inst1|j[7]~0_combout\ & \inst1|j\(7))) # (!\inst1|j[7]~1_combout\))) # (!\inst1|Add1~14_combout\ & (\inst1|j[7]~0_combout\ & (\inst1|j\(7))))
...
-- Equation(s):
-- \inst1|Equal1~0_combout\ = (!\inst1|j\(5) & (!\inst1|j\(6) & \inst1|j\(7)))
...
-- Equation(s):
-- \inst1|Equal1~1_combout\ = (!\inst1|j\(2) & (!\inst1|j\(1) & (!\inst1|j\(3) & \inst1|j\(4))))
...
-- Equation(s):
-- \inst1|i~1_combout\ = (\inst1|Add0~2_combout\ & ((\inst1|Equal0~1_combout\) # (\inst1|Equal0~0_combout\)))
...
-- Equation(s):
-- \inst1|j[7]~0_combout\ = (\inst1|Equal0~2_combout\ & ((\inst1|j\(0)) # ((!\inst1|Equal1~1_combout\) # (!\inst1|Equal1~0_combout\))))
...
-- Equation(s):
-- \inst1|j[7]~1_combout\ = (\inst1|Equal0~2_combout\) # ((!\inst1|j\(0) & (\inst1|Equal1~0_combout\ & \inst1|Equal1~1_combout\)))
...
-- Equation(s):
-- \inst1|Mux0~0_combout\ = (\inst1|j\(3) & (\inst1|j\(0) $ (((!\inst1|j\(2)) # (!\inst1|j\(1)))))) # (!\inst1|j\(3) & (\inst1|j\(2) $ (((\inst1|j\(1) & \inst1|j\(0))))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1001010001111010",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \inst1|j\(3),
...
-- Equation(s):
-- \inst1|Mux0~2_combout\ = (\inst1|j\(3) & (\inst1|j\(0) $ (((\inst1|j\(1)) # (\inst1|j\(2)))))) # (!\inst1|j\(3) & (\inst1|j\(0) & (\inst1|j\(1) $ (\inst1|j\(2)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0011011001001000",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \inst1|j\(1),
...
-- Equation(s):
-- \inst1|Mux0~1_combout\ = (\inst1|j\(2) & ((\inst1|j\(0) & ((!\inst1|j\(3)))) # (!\inst1|j\(0) & (!\inst1|j\(1) & \inst1|j\(3))))) # (!\inst1|j\(2) & (\inst1|j\(1) & ((\inst1|j\(0)) # (!\inst1|j\(3)))))
...
-- Equation(s):
-- \inst1|Mux0~3_combout\ = (\inst1|j\(4) & ((\inst1|j\(5)) # ((\inst1|Mux0~1_combout\)))) # (!\inst1|j\(4) & (!\inst1|j\(5) & (\inst1|Mux0~2_combout\)))
...
-- Equation(s):
-- \inst1|Mux0~6_combout\ = \inst1|j\(0) $ (((\inst1|j\(1) & (!\inst1|j\(4) & \inst1|j\(2)))))
...
-- Equation(s):
-- \inst1|Mux0~10_combout\ = (\inst1|j\(0) & (((!\inst1|j\(2))) # (!\inst1|j\(1)))) # (!\inst1|j\(0) & (\inst1|j\(4) & (\inst1|j\(1) $ (\inst1|j\(2)))))
...
-- Equation(s):
-- \inst1|Mux0~7_combout\ = (\inst1|j\(4) & (\inst1|j\(2) $ (((\inst1|j\(1) & \inst1|j\(0)))))) # (!\inst1|j\(4) & ((\inst1|j\(2) & ((\inst1|j\(0)))) # (!\inst1|j\(2) & (\inst1|j\(1)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0110101011100100",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \inst1|j\(2),
...
-- Equation(s):
-- \inst1|Mux0~8_combout\ = (\inst1|j\(0) & (!\inst1|j\(2) & (\inst1|j\(1) $ (!\inst1|j\(4))))) # (!\inst1|j\(0) & ((\inst1|j\(1) & ((!\inst1|j\(4)))) # (!\inst1|j\(1) & (\inst1|j\(2)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0001100000110110",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \inst1|j\(1),
...
-- Equation(s):
-- \inst1|Mux0~9_combout\ = (\inst1|j\(3) & ((\inst1|j\(5)) # ((\inst1|Mux0~7_combout\)))) # (!\inst1|j\(3) & (!\inst1|j\(5) & ((\inst1|Mux0~8_combout\))))
...
-- Equation(s):
-- \inst1|Mux0~14_combout\ = (\inst1|Mux0~12_combout\) # ((!\inst1|j\(4) & (\inst1|Equal1~0_combout\ & \inst1|Mux0~13_combout\)))
...
-- Equation(s):
-- \inst3|Mux0~13_combout\ = (\inst1|j\(0) & ((\inst1|j\(3)) # (\inst1|j\(2) $ (\inst1|j\(1))))) # (!\inst1|j\(0) & ((\inst1|j\(1) & (\inst1|j\(2))) # (!\inst1|j\(1) & ((\inst1|j\(3))))))
...
-- Equation(s):
-- \inst3|Mux0~0_combout\ = (\inst1|j\(0) & ((\inst1|j\(1) & ((\inst1|j\(2)))) # (!\inst1|j\(1) & (!\inst1|j\(4))))) # (!\inst1|j\(0) & (\inst1|j\(4) $ (((!\inst1|j\(1) & \inst1|j\(2))))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1110001101000110",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \inst1|j\(0),
...
-- Equation(s):
-- \inst3|Mux0~4_combout\ = (\inst1|j\(0) & ((\inst1|j\(4) & (!\inst1|j\(1) & \inst1|j\(2))) # (!\inst1|j\(4) & (\inst1|j\(1))))) # (!\inst1|j\(0) & ((\inst1|j\(2) & ((!\inst1|j\(1)))) # (!\inst1|j\(2) & (\inst1|j\(4)))))
...
-- Equation(s):
-- \inst3|Mux0~1_combout\ = (\inst1|j\(0) & ((\inst1|j\(4) & ((!\inst1|j\(2)) # (!\inst1|j\(1)))) # (!\inst1|j\(4) & (!\inst1|j\(1) & !\inst1|j\(2))))) # (!\inst1|j\(0) & (((\inst1|j\(1)) # (\inst1|j\(2)))))
...
-- Equation(s):
-- \inst3|Mux0~6_combout\ = (\inst1|j\(0) & ((\inst1|j\(3) & ((!\inst1|j\(1)) # (!\inst1|j\(2)))) # (!\inst1|j\(3) & ((\inst1|j\(1)))))) # (!\inst1|j\(0) & (\inst1|j\(2) & ((!\inst1|j\(1)))))
...
-- Equation(s):
-- \inst3|Mux0~10_combout\ = (\inst1|j\(2) & (\inst1|j\(1) $ (((!\inst1|j\(0) & \inst1|j\(3)))))) # (!\inst1|j\(2) & ((\inst1|j\(0) & ((!\inst1|j\(3)) # (!\inst1|j\(1)))) # (!\inst1|j\(0) & ((\inst1|j\(3))))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1001011111011000",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \inst1|j\(2),
...
-- Equation(s):
-- \inst3|Mux0~8_combout\ = (\inst1|j\(0) & (\inst1|j\(3) $ (((!\inst1|j\(2) & !\inst1|j\(1)))))) # (!\inst1|j\(0) & ((\inst1|j\(2) & (!\inst1|j\(3))) # (!\inst1|j\(2) & ((\inst1|j\(3)) # (\inst1|j\(1))))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1011010110010110",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \inst1|j\(0),
...
-- Equation(s):
-- \inst3|Mux0~14_combout\ = (\inst3|Mux0~12_combout\) # ((!\inst3|Mux0~13_combout\ & (!\inst1|j\(4) & \inst1|Equal1~0_combout\)))
